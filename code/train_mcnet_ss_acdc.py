...
parser.add_argument('--exp', type=str, default='DC_At_0_Pt', help='experiment_name')
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            logging.info('iteration %d : loss : %03f,  loss_seg_dice: %03f, loss_at_kd: %03f, loss_dc0: %03f, cur_threshold: %03f, '
                         'loss_cer: %03f, mean_max_values: %03f' % (
            iter_num, loss, loss_seg_dice, loss_at_kd, loss_dc0, cur_threshold, loss_cer, mean_max_values))
            if iter_num % 20 == 0:
