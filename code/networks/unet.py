...
class Decoder_MC(nn.Module):
    def __init__(self, params):
        super(Decoder_MC, self).__init__()
        self.params = params
        self.in_chns = self.params['in_chns']
        self.ft_chns = self.params['feature_chns']
        self.n_class = self.params['class_num']
...
class MCNet2d_KD(nn.Module):
    def __init__(self, in_chns, class_num):
        ...
        params2 = {'in_chns': in_chns,
                   ...
                   'up_type': 0,
                   'acti_func': 'relu'}
        self.encoder = Encoder_KD(params1)
        self.decoder1 = Decoder_KD(params1)
        self.decoder2 = Decoder_MC(params2)


    def forward(self, x):
        features, encoder_features = self.encoder(x)
        output1, decoder_features1 = self.decoder1(features)
        output2, decoder_features2 = self.decoder2(features)

        return output1, output2, encoder_features, decoder_features1, decoder_features2
